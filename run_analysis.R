...
# print(paste("subject_train dims: (", dim(subject_train)[1], ",", dim(subject_train)[2], ")", sep = ""))
# print(paste("X_test dims: (", dim(X_test)[1], ",", dim(X_test)[2], ")", sep = ""))
# print(paste("y_test dims: (", dim(y_test)[1], ",", dim(y_test)[2], ")", sep = ""))
# print(paste("subject_test dims: (", dim(subject_test)[1], ",", dim(subject_test)[2], ")", sep = ""))
...
columnwise_mean = mean_std_measurements %>% group_by(activity_labels, subject) %>%
